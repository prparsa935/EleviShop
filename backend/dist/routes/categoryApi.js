...
categoryApi.delete("/admin/delete/:id", categoryController.deleteCategory, overallErrorHandler);
categoryApi.put("/admin/update/:id", categoryController.updateCategory, overallErrorHandler);
categoryApi.post("/admin/update/:id", categoryController.updateCategory, overallErrorHandler);
