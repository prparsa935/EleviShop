            ...
            <div className=" w-100   fixed border-b-2 z-50 bg-white">
                ...
                <div className="pb-3 mx-auto  mt-9 container max-w-screen-2xl flex lg:justify-between items-center px-5 ">
                    ...
                    <div className="lg:flex hidden">
                        <Button shape='rounded-lg' morCss='ml-3 border-2' size='md'><i className=" font-medium fa-light fa-cart-shopping"></i></Button>
                        <Button shape='rounded-lg' icon={<i class="fas fa-sign-in"></i>} morCss='border-2  '  size='md'>ورود<Separator orientation="vertical" className={'bg-slate-400 mx-2'}></Separator> ثبت نام</Button>
                ...
                {/* navbar */}
                <div ref={navEl}  data-scrolled='false' className=" duration-300 h-0 data-[scrolled=false]:lg:h-12 overflow-hidden items-center px-5 mx-auto  container max-w-screen-2xl ">
                    <div className="flex items-stretch">
                        <NavTab>
                            <Button size='md' border='none ' icon={<i class="pl-2 fa-thin fa-bars"></i>} >دسته بندی کالا ها</Button>
                            
                            
                        </NavTab>
                        <Separator orientation="vertical" className={'bg-slate-400 mx-2 h-auto'}></Separator>
                        
                        
                        <NavTab>
                            <Button txtColor='text-slate-600' size='xs' border='none ' icon={<i class="fa-light fa-basket-shopping"></i>} >شگفت انگیز ها</Button>
                        </NavTab>
                        <NavTab>
                            <Button txtColor='text-slate-600' size='xs' border='none ' icon={<i class="fal fa-fire"></i>} >پرفروش ترین ها</Button>

                        </NavTab>
                        <NavTab>
                        
                            <Button txtColor='text-slate-600' size='xs' border='none ' icon={<i class="fa-light fa-badge-dollar"></i>} >تخفیف ها</Button>
                        </NavTab>
                        <NavTab>
                            <Button txtColor='text-slate-600' size='xs' border='none '  >سوالی دارید ؟</Button>
