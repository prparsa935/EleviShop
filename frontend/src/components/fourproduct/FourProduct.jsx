import imageExample1 from '../../assets/img/d96e7ea767ac9c2f0e4dc0316a625a276c5716df_1716971139.webp'
...
const FourProduct=()=>{
    return (
        <div className="container max-w-screen-xl lg:mx-auto  grid lg:grid-cols-4 grid-cols-2 gap-x-4 gap-y-4 justify-center px-3">
            ...
            <div className='flex justify-center'>
                <img className=' rounded-2xl' src={imageExample2}></img>

            </div>
            <div className='flex justify-center'>
                <img className=' rounded-2xl' src={imageExample3}></img>
