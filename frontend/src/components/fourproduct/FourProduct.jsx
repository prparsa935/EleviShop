  ...
  return (
    <div className="container max-w-screen-xl lg:mx-auto  grid lg:grid-cols-4 grid-cols-2 gap-x-4 gap-y-4 justify-center px-3">
      <div className="flex justify-center">
        <SmartImage className=" rounded-2xl" src={imageExample1} alt="" eager ratio="1/1" />
      </div>
      <div className="flex justify-center">
        <SmartImage className=" rounded-2xl" src={imageServerAddress + "/102.jpg"} alt="" ratio="1/1" />
      </div>
      <div className="flex justify-center">
        <SmartImage className=" rounded-2xl" src={imageServerAddress+"/0838826b3d938e102a3ac44f34084e4128adcfa4_1722320454.jpg"} alt="" ratio="1/1" />
      </div>
      <div className="flex justify-center">
        <SmartImage className=" rounded-2xl" src={imageExample4} alt="" ratio="1/1" />
      </div>
    </div>
  );
};
