...
const Login = () => {
  return (
    <div className="login-page flex items-center justify-center h-screen">
      <div className="w-full lg:w-[400px]  lg:border rounded-2xl h-[440px] p-8 flex flex-col">
        {/* header */}
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-7">
            <Button  bgColor='bg-rose-500' txtColor="text-white" moreCss='w-full' shape='rounded-lg'>ورود</Button>
