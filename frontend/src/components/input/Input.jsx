...
const Input = (props) => {
  ...
  return (
    <div style={{ width: props.width }} className="flex flex-col">
      <div
        className={
          " relative  input-container  flex items-center  " +
          " " +
          (props.disabled ? "sub-txt-color" : "") +
          " " +
      ...
      >
        ...
        {props.type === "textarea" ? (
          <textarea
            ...
            className={
              " flex-grow  custom-input    rounded w-100 " +
              (props.iMessage ? "border-bf-red  " : "")
            }
            style={{
              height: props.height,
            }}
      ...
      <div
        className={
          "text-bf-red  mt-1  transition-400 font-semibold overflow-hidden  " +
          (props.iMessage ? "h-5" : "h-0")
        }
      >
        {props.iMessage}
      </div>
