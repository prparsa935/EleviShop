...
const Modal=(props)=>{
    ...
    return(
        <div ref={modalRef} className={"absolute top-0 w-100 h-100vh flex justify-center  bg-opacity-70 bg-black duration-500  z-50      "}>
            <div ref={modalContent} style={{height:props.height}}  className={" bg-white modal-content border relative scale-0 duration-500 self-center overflow-y-scroll "+props.className}>
